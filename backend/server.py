...
async def seed_demo_data():
    ...
    # Create dimensions with weights (sum = 100)
    dimensions_data = [
        {"name": "Strategy & Outcomes", "description": "Product vision, roadmap, and strategic alignment", "weight": 15, "order": 1},
        {"name": "Customer & Discovery", "description": "User research, validation, and empathy", "weight": 12, "order": 2},
        {"name": "Backlog & Prioritization", "description": "Backlog health, prioritization methods", "weight": 15, "order": 3},
        {"name": "Delivery Partnership", "description": "Collaboration with Eng/Design/Data", "weight": 12, "order": 4},
        {"name": "Stakeholder Management", "description": "Communication, influence, alignment", "weight": 12, "order": 5},
        {"name": "Execution & Reliability", "description": "Commitment delivery, sprint discipline", "weight": 10, "order": 6},
        {"name": "Data & Metrics", "description": "Success metrics, evidence-based decisions", "weight": 14, "order": 7},
        {"name": "Governance & Ways of Working", "description": "Compliance, risk, best practices", "weight": 10, "order": 8}
    ]
